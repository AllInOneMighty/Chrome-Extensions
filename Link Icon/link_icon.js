...
LinkIcon.addIcon(
  new Icon('gmail', 'Gmail', 10, 40)
      ...
      .setMatches(function(location, link, linkExtension) {
        ...
        return link.hostname == "mail.google.com" || link.hostname == "www.gmail.com";
      })
      .setIconIdsToDeactivate(['external']));
...
LinkIcon.addIcon(
  new Icon('app', 'Application', 0, 50)
      ...
      .setImage(
        new IconImage()
            .setBase64('')
      )
      .setMatches(function(location, link, linkExtension) {
        return linkExtension == ".exe" || linkExtension == ".app" || linkExtension == ".bat" || linkExtension == ".com" || linkExtension == ".pif";
      }));
LinkIcon.addIcon(
...
LinkIcon.addIcon(
  new Icon('video', 'Video', 0, 65)
      ...
      .setImage(
        new IconImage()
            .setBase64('')
      )
      .setMatches(function(location, link, linkExtension) {
        return linkExtension == ".avi" || linkExtension == ".mpeg" || linkExtension == ".mpg" || linkExtension == ".divx" || linkExtension == ".wmv" ||
            linkExtension == ".3g2" || linkExtension == ".3gp" || linkExtension == ".asf" || linkExtension == ".asx" || linkExtension == ".dvr-ms" ||
            linkExtension == ".f4v" || linkExtension == ".fbr" || linkExtension == ".flv" || linkExtension == ".mp4" || linkExtension == ".mts" ||
            linkExtension == ".ogm" || linkExtension == ".rcproject" || linkExtension == ".scm" || linkExtension == ".smil" ||
            linkExtension == ".swf" || linkExtension == ".ts" || linkExtension == ".vob" || linkExtension == ".vro" || linkExtension == ".xvid";
      }));

// Security
LinkIcon.addIcon(
  new Icon('secure', 'Secure connection', 0, 90)
      .setDescription('A SSL secured connection will be opened by clicking on this link (only displayed on non secured pages).')
      .setImage(
        new IconImage()
            .setBase64('')
      )
      .setMatches(function(location, link, linkExtension) {
