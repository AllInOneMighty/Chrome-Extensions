// Because Chrome Extensions support for modules is absolute trash, we'll put
// everything in the same file since it's the only sane way to not fry your
// brain to get it to work.
//
// Enjoy the unfortunate gigantic file.
...
function getRootDomainName(host: string) {
...
function isSameRootDomainName(host1: string, host2: string) {
...
class Icon {
  constructor(
      readonly id: IconId, readonly name: string, readonly description: string,
      readonly priority: Number, readonly settingsOrder: Number,
...
function buildIcons(): Map<IconId, Icon> {
  ...
  addIcon(
      new Icon(
          ...
          (location: Location, link: HTMLLinkElement,
           linkExtension: string) => {
            return linkExtension == FileExtension.APP ||
                linkExtension == FileExtension.BAT ||
                linkExtension == FileExtension.COM ||
                linkExtension == FileExtension.EXE ||
  ...
  addIcon(
      new Icon(
          ...
          (location: Location, link: HTMLLinkElement,
           linkExtension: string) => {
            return linkExtension == FileExtension.GZ ||
                linkExtension == FileExtension.JAR ||
                linkExtension == FileExtension.RAR ||
                linkExtension == FileExtension._7Z ||
                linkExtension == FileExtension.SFX ||
                linkExtension == FileExtension.SIT ||
                linkExtension == FileExtension.SITX ||
                linkExtension == FileExtension.TGZ ||
                linkExtension == FileExtension.ZIP ||
                linkExtension == FileExtension.ZIPX;
          }),
      iconsMap);
  addIcon(
      new Icon(
          IconId.DOCUMENT, 'Document', 'A rich-text document (doc, rtf, ...).',
          ...
          (location: Location, link: HTMLLinkElement,
           linkExtension: string) => {
            return linkExtension == FileExtension.DOC ||
                linkExtension == FileExtension.DOCX ||
                linkExtension == FileExtension.RTF ||
                linkExtension == FileExtension.WPD ||
  ...
  addIcon(
      new Icon(
          ...
          (location: Location, link: HTMLLinkElement,
           linkExtension: string) => {
            return linkExtension == FileExtension.BMP ||
                linkExtension == FileExtension.GIF ||
                linkExtension == FileExtension.JPEG ||
                linkExtension == FileExtension.JPG ||
                linkExtension == FileExtension.PNG ||
                linkExtension == FileExtension.SVG ||
  ...
  addIcon(
      new Icon(
          ...
          (location: Location, link: HTMLLinkElement,
           linkExtension: string) => {
            return linkExtension == FileExtension.JAR ||
  ...
  addIcon(
      new Icon(
          ...
          (location: Location, link: HTMLLinkElement,
           linkExtension: string) => {
            return linkExtension == FileExtension.AAC ||
                linkExtension == FileExtension.AIF ||
                linkExtension == FileExtension.CAF ||
                linkExtension == FileExtension.CPR ||
                linkExtension == FileExtension.FLAC ||
                linkExtension == FileExtension.IFF ||
                linkExtension == FileExtension.M3U ||
                linkExtension == FileExtension.MID ||
                linkExtension == FileExtension.MIDI ||
                linkExtension == FileExtension.MP3 ||
                linkExtension == FileExtension.MPA ||
                linkExtension == FileExtension.OGG ||
                linkExtension == FileExtension.RA ||
                linkExtension == FileExtension.RNS ||
                linkExtension == FileExtension.SIB ||
                linkExtension == FileExtension.SND ||
                linkExtension == FileExtension.WAV ||
  ...
  addIcon(
      new Icon(
          ...
          (location: Location, link: HTMLLinkElement,
           linkExtension: string) => {
            return linkExtension == FileExtension.PPT ||
  ...
  addIcon(
      new Icon(
          ...
          (location: Location, link: HTMLLinkElement,
           linkExtension: string) => {
            return linkExtension == FileExtension.MOV ||
  ...
  addIcon(
      new Icon(
          ...
          (location: Location, link: HTMLLinkElement,
           linkExtension: string) => {
            return linkExtension == FileExtension.RM ||
  ...
  addIcon(
      new Icon(
          ...
          (location: Location, link: HTMLLinkElement,
           linkExtension: string) => {
            return linkExtension == FileExtension.XLS ||
  ...
  addIcon(
      new Icon(
          ...
          (location: Location, link: HTMLLinkElement,
           linkExtension: string) => {
            return linkExtension == FileExtension.LOG ||
  ...
  addIcon(
      new Icon(
          ...
          (location: Location, link: HTMLLinkElement,
           linkExtension: string) => {
            const url = new URL(link.href);
            linkExtension = url.pathname.substring(
                url.pathname.substring(0, url.pathname.lastIndexOf('.'))
                    .lastIndexOf('.'));
            return linkExtension == FileExtension.USER_JS;
          })
  ...
  addIcon(
      new Icon(
          ...
          (location: Location, link: HTMLLinkElement,
           linkExtension: string) => {
            return linkExtension == FileExtension._3G2 ||
                linkExtension == FileExtension._3GP ||
                linkExtension == FileExtension.ASF ||
                linkExtension == FileExtension.ASX ||
                linkExtension == FileExtension.AVI ||
                linkExtension == FileExtension.DIVX ||
                linkExtension == FileExtension.DVR_MS ||
                linkExtension == FileExtension.F4V ||
                linkExtension == FileExtension.FBR ||
                linkExtension == FileExtension.FLV ||
                linkExtension == FileExtension.MP4 ||
                linkExtension == FileExtension.MPEG ||
                linkExtension == FileExtension.MPG ||
                linkExtension == FileExtension.MTS ||
                linkExtension == FileExtension.OGM ||
                linkExtension == FileExtension.RCPROJECT ||
                linkExtension == FileExtension.SCM ||
                linkExtension == FileExtension.SMIL ||
                linkExtension == FileExtension.SWF ||
                linkExtension == FileExtension.TS ||
                linkExtension == FileExtension.VOB ||
                linkExtension == FileExtension.VRO ||
                linkExtension == FileExtension.WMV ||
                linkExtension == FileExtension.XVID;
          }),
      iconsMap);
...
function getTooltipContents(link: HTMLLinkElement) {
  ...
  if (url.protocol == Protocol.HTTP || url.protocol == Protocol.HTTPS ||
      url.protocol == Protocol.FTP || url.protocol == Protocol.FILE) {
...
var mousemoveFunction = (event: MouseEvent) => {
