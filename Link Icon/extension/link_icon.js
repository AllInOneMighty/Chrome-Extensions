...
function isSameRootDomainName(host1, host2) {
    return getRootDomainName(host1) == getRootDomainName(host2);
}
class LinkIcons {
    iconIds = [];
    isEmpty() {
...
class LinkIcon {
    ...
    getIconsByPriority() {
        if (this.iconsByPriority == undefined) {
            this.iconsByPriority = this.sortIconsBy((icon) => {
    ...
    ;
    getIconsBySettingsOrder() {
        if (this.iconsBySettingsOrder == undefined) {
            this.iconsBySettingsOrder = this.sortIconsBy((icon) => {
...
function buildIcons() {
    ...
    addIcon(new Icon("gmail", 'Gmail', 'Redirects to Google Mail.', 10, 40, '', (location, link, linkExtension) => {
        ...
        .setIconIdsToDeactivate(["external"]), iconsMap);
    addIcon(new Icon("app", 'Application', 'An application file (app, bat, exe, ...).', 0, 50, '', (location, link, linkExtension) => {
        return linkExtension == ".app" ||
            linkExtension == ".bat" ||
            linkExtension == ".com" ||
            linkExtension == ".exe" ||
            linkExtension == ".pif";
    }), iconsMap);
    addIcon(new Icon("archive", 'Archive', 'A compressed file or an archive (7z, rar, zip, ...).', 0, 64, '', (location, link, linkExtension) => {
        return linkExtension == ".gz" ||
            linkExtension == ".jar" ||
            linkExtension == ".rar" ||
            linkExtension == ".7z" ||
            linkExtension == ".sfx" ||
    ...
    addIcon(new Icon("secure", 'Secure connection', 'A SSL secured connection will be opened by clicking on this link (only displayed on non secured pages).', 0, 90, '', (location, link, linkExtension) => {
        const url = new URL(link.href);
...
document.addEventListener('mouseenter', (event) => { document.addEventListener('mousemove', mousemoveFunction); });
